...
def export_tflite(model: tf.keras.Model, output_dir: Path) -> Path:
    ...
    # Use the current converter and LiteRT runtime.  This preserves the
    # optimized EfficientNet graph and avoids pinning the mobile app to the
    # obsolete TensorFlow Lite 2.12 iOS pods.
